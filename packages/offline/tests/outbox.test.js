...
import { buildOutboxRecord, verifyOutboxIntegrity } from '../src/outbox';
...
describe('verifyOutboxIntegrity', () => {
    ...
    it('throws OUTBOX_BODY_HASH_MISMATCH for tampered body', () => {
        ...
        const tampered = { ...rec, body: '{"title":"evil"}' };
        expect(() => verifyOutboxIntegrity(tampered)).toThrow(expect.objectContaining({ code: 'OUTBOX_BODY_HASH_MISMATCH' }));
    });
});
...
//# sourceMappingURL=outbox.test.js.map